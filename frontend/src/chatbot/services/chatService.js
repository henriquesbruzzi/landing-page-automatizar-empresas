...
class ChatService {
  ...
  async simulateAIResponse(message, lang, context) {
    ...
    if (lowerMessage.includes('contacto') || lowerMessage.includes('contato') || lowerMessage.includes('contact')) {
      return lang === 'pt'
        ? 'Pode entrar em contacto connosco através do email geral@nexugal.com ou pelo telefone +351 912 423 912. Também pode preencher o formulário de contacto na nossa página. Como prefere?'
        : 'You can contact us via email at geral@nexugal.com or by phone at +351 912 423 912. You can also fill out the contact form on our page. How would you prefer?';
    }
