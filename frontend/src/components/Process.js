    ...
    <section id="processo" className="relative py-24 md:py-32 bg-black overflow-hidden" aria-labelledby="process-title">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        <Entrada className="text-center mb-20">
          <span className="font-display text-cyan-neon text-sm font-semibold tracking-[0.3em] uppercase mb-4 block">
            {t.process.subtitle}
          </span>
          <h2 id="process-title" className="font-display text-white text-3xl md:text-4xl lg:text-5xl font-bold tracking-[0.05em]">
            {t.process.title}
        ...
        <div className="relative">
          ...
          <Entrada
            className="hidden lg:block absolute top-1/2 left-0 right-0 h-[1px] bg-gradient-to-r from-cyan-neon/0 via-cyan-neon/30 to-cyan-neon/0"
            aria-hidden="true"
          />

          {/* Em ecrãs estreitos os passos empilham e a linha desce pelo lado */}
          <Entrada
            className="lg:hidden absolute top-4 bottom-4 left-[15px] w-[1px] bg-gradient-to-b from-cyan-neon/0 via-cyan-neon/30 to-cyan-neon/0"
            aria-hidden="true"
          />
              ...
              >
                <div className={`relative h-full p-6 md:p-7 rounded-2xl border border-white/10 ${FUNDO} group-hover:border-cyan-neon/30 transition-colors duration-500`}>
                  ...
                  <div className="w-12 h-12 rounded-full border border-cyan-neon/25 flex items-center justify-center mb-5 group-hover:border-cyan-neon/60 group-hover:shadow-[0_0_20px_rgba(0,209,255,0.15)] transition-all duration-500">
                    <span className="font-display text-cyan-neon text-sm font-bold tracking-wider">
                      {step.number}
                    </span>
                  </div>

                  {/* Etapa */}
                  <h3 className="font-display text-cyan-neon text-xs font-semibold tracking-[0.25em] uppercase mb-3">
                    {step.keyword}
                  </h3>
